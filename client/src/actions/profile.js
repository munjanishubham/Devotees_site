...
// Get profiles by pandit id
export const getProfileById = panditId => async dispatch => {
    try {
        const res = await axios.get(`/api/profile/pandit/${panditId}`);        
        dispatch({
