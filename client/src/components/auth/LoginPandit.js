...
import {login} from '../../actions/authPandit';

const LoginPandit = ({ login, isPanditAuthenticated }) => {
                    ...
                    <div className="common-form">
                        <div className="form-side">
                            <div className="heading-common">
                                <h1><strong>Log in Pandit </strong>
                        ...
                        <div className="img-side">
                            <img src={require("../../img/pandit8.svg")} alt="" className="register-user" />
                        </div>
                    </div>
                </div>
            </section>    
...
LoginPandit.propTypes ={
    login: PropTypes.func.isRequired,
    isPanditAuthenticated: PropTypes.bool
};
const mapStateToProps = state => ({
    isPanditAuthenticated: state.authPandit.isPanditAuthenticated
});

export default connect(mapStateToProps, {login})(LoginPandit);
