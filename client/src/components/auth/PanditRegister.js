...
import { register} from '../../actions/authPandit';
import PropTypes from 'prop-types';
import {connect} from 'react-redux';


const PanditRegister = ({ setAlert, register, isPanditAuthenticated }) => {
...
export default connect(mapStateToProps, {setAlert, register})(PanditRegister);
