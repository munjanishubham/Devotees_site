            ...
            <div className="form-side">
              ...
              <form onSubmit={(e) => onSubmit(e)}>
                ...
                <div className="form-group">
                  ...
                  />
                  <small className="form-text text-muted">
                    Could be your own language or one you work{" "}
                  </small>
                </div>
                {/* <div className="form-group">
                  <input
                ...
                <div className="form-group">
                  ...
                  />
                  <small className="form-text text-muted">
                    At which time you are available for devotees, mention day
                    with time.{" "}
                  </small>
                </div>
                <div className="form-group">
                ...
                <div className="form-group">
                  ...
                  />
                  <small className="form-text text-muted">
                    Could be your own or a language website{" "}
                  </small>
                </div>
                <div className="form-group">
                  <input
                  ...
                  />
                  <small className="form-text text-muted">
                    Could be your own language address or one you work{" "}
                  </small>
                </div>
                <div className="form-group">
                  <textarea
