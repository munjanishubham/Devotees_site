...
router.post(
  ...
  [
    authUser,
    [
      check("devoteename", "Devotee name is required").not().isEmpty(),
      check("location", "Location is required").not().isEmpty(),
      check("age", "Mobile No: is required").not().isEmpty(),
  ...
  async (req, res) => {
    ...
    try {
      ...
      const pandit = await Pandit.findById(req.params.pandit_id).select(
        "-password"
      );
